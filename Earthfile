...
kbt-test:
    ...
    COPY +kbt-test-nomad-manifests/results_junit.xml ${TEST_OUTPUT}/unit/nomad/results_junit.xml
    WAIT
        RUN --no-cache echo Forcing save test artifacts
        SAVE ARTIFACT ${TEST_OUTPUT} AS LOCAL .
    END
...
kbt-test-nomad-manifests:
    ...
    COPY --dir project.yml nomad /data/service/ktools/repos/api-ratelimit/
